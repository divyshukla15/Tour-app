    ...
    Location(
        ...
        facts: <LocationFact>[
          LocationFact(
              title: 'Summary',
              text:
                  't\'s pleasures extend beyond the visual realm'),
          LocationFact(
    ...
    Location(
        ...
        facts: <LocationFact>[
          ...
          LocationFact(
              title: 'Did You Know',
              text:
                  'The Golden Pavilion is set in a magnificent Japanese strolling garden.The Golden Pavilion is set in a magnificent Japanese strolling garden.')
        ],
        tour_package_name: '',
        user_itinerary_summary: ''),
    Location(
